...
@section("content")
      <div class="card">
        ...
        <div class="row">
        <div class="col-md-12">
                <table class="table table-hover table-bordered dataTable" id="journalVolumeTable" >
                  <thead>
                    <tr>
                      <th>Sl</th>
                      <th>Volume No</th>
...
@push('scripts')
   ...
   <script>
    $(document).ready(function() {
      ...
      var categoryTable = $('#journalVolumeTable').DataTable({
        searching: true, 
        processing: true,
        serverSide: true,
        ordering: false,
        ...
        stateSave: true,
        ajax: {
          url: "{{route('admin.journal-volume.index')}}",
        },
        columns: [
