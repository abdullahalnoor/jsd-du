<header class="app-header"><a class="app-header__logo" href="">JSD-ISWR</a>
      ...
      <ul class="app-nav">
        ...
        <b>Account</b>
          ...
          <ul class="dropdown-menu settings-menu dropdown-menu-right">
            ...
            <li><a class="dropdown-item" href="{{route('admin.profile.update.password')}}"><i class="bi bi-key me-2 fs-5"></i> Update Password</a></li>
            <li>
