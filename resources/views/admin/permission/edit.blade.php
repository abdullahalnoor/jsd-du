          ...
          <div class="tile">
            ...
            <div class="tile-body">
                ...
                <div class="mb-3">
                  ...
                  <input class="form-control" name="name" value="{{old('name',$permission->name)}}" type="text" placeholder="Enter Name">
                  @error('name')
                ...
                <div class="mb-3">
                  ...
                  <input class="form-control" name="route" value="{{old('slug',$permission->slug)}}" type="text" placeholder="Enter Route">
                  @error('route')
                  <b class="form-text text-danger">{{$message}} </b>
                  @enderror
                </div>
