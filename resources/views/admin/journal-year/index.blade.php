...
@section("content")
      <div class="card">
        ...
        <div class="row">
        <div class="col-md-12">
                <table class="table table-hover table-bordered dataTable" id="journalYearTable" >
                  <thead>
                    <tr>
                      <th>Sl</th>
                      <th>Year</th>
...
@push('scripts')
   ...
   <script>
    $(document).ready(function() {
      ...
      var categoryTable = $('#journalYearTable').DataTable({
        searching: true, 
        processing: true,
        serverSide: true,
        ordering: false,
        ...
        stateSave: true,
        ajax: {
          url: "{{route('admin.journal-year.index')}}",
        },
        columns: [
             { data: 'DT_RowIndex', name: 'DT_RowIndex', orderable: false, searchable: false },
            {data: 'journal_year', name: 'journal_year'},
