...
@section("content")
      <div class="card">
        ...
        <div class="row">
        <div class="col-md-12">
                <table class="table table-hover table-bordered dataTable" id="boardMemberTable" >
                  <thead>
                    <tr>
                      <th>Sl</th>
                      <th>Name </th>
...
@push('scripts')
   ...
   <script>
    $(document).ready(function() {
      ...
      var categoryTable = $('#boardMemberTable').DataTable({
        searching: true, 
        processing: true,
        serverSide: true,
        ordering: false,
        ...
        stateSave: true,
        ajax: {
          url: "{{route('admin.board-member.index')}}",
        },
        columns: [
