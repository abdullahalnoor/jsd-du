  ...
  <div class="container">
    ...
    <div class="row justify-content-center gy-5 gx-lg-5">
      ...
      @include('frontend.includes.alert')
        ...
        <form action="{{route('member.register.form')}}" method="post" role="form" class="contact-form " >
        @csrf
          ...
          Name<b><i class="text-danger">*</i></b>
            ...
            <input type="name" class="form-control" name="name" id="name" placeholder="Enter Name.." value="{{old('name')}}" required>
            @error('name')
          ...
          <div class="">
            <button class="btn btn-primary mt-2  mr-5" type="submit">Register</button>
            <a  class="  text-primary " href="{{route('member.register.form')}}">  Login </a>
